...
1.	Prepare PCR mix as described in the PCR [protocol](https://github.com/buckleylab/Buckley_lab_protocols/tree/master/PCR).
...
4.	Insert plate into thermocycler and close lid. Set the PCR conditions as optimized for your primers. 

## Size Selection

Verify the size of your amplicon by running it on an agarose gel prepared with 0.5x TE buffer as described [here](https://github.com/buckleylab/Buckley_lab_protocols/blob/master/gel_electrophoresis/gel_extraction.md). For PCR products, 1 uL + 5 uL of loading dye can be run on a 1% gel (with SYBR Safe). 
...
7. Wash step: Add 200ul 75% EtOH, allow beads to settle, remove EtOH and repeat once.
...
1.	Dilute primer to 25 pmol/uL (or recommended concentration from sequencing center) with DNase-free water (only one primer may be added per sample for Sanger sequencing). The BRC also supplies universal primers in lieu of our pre-mixed ones. 

2.	Add 2 uL of this solution to 16 uL of cleaned PCR product in specially marked sequencing tubes. For additional info on the volumes of DNA and primer required for sequencing and sample submission guidelines, refer to the [BRC's website](http://www.biotech.cornell.edu/node/556). 
